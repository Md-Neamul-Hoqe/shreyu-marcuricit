...
const MENU_ITEMS: MenuItemTypes[] = [
  ...
  { key: "tasks", label: "Tasks", isTitle: true },
  {
    key: "employees",
    label: "Employees",
    isTitle: false,
    ...
    children: [
      ...
      },
      {
        key: "leaves-admin",
        label: "Leaves (Admin)",
        url: "/employees/leaves-admin",
        parentKey: "employees",
      },
      {
        key: "leaves-employee",
        label: "Leaves (Employee)",
        url: "/employees/leaves-employee",
        parentKey: "employees",
      },
      {
        key: "leave-settings",
        label: "Leave Settings",
        url: "/employees/leaves-settings",
        parentKey: "employees",
      },
      {
        key: "attendance-admin",
        label: "Attendance (Admin)",
        url: "/employees/attendance-admin",
        parentKey: "employees",
      },
      {
        key: "attendance-employee",
        label: "Attendance (Employee)",
        url: "/employees/attendance-employee",
        parentKey: "employees",
      },
    ],
  },
